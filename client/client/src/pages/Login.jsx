...
import { Eye, EyeOff, ShieldAlert, CheckCircle2, Lock, Mail } from 'lucide-react';
...
const Login = () => {
  ...
  // Redirect to original route or default to home/profile
          ...
          <form className="space-y-6" onSubmit={handleSubmit} noValidate>
            ...
            <div>
              <div className="flex justify-between items-center">
                <label htmlFor="current-password" className="block text-sm font-semibold text-slate-300">
                  Password
                </label>
